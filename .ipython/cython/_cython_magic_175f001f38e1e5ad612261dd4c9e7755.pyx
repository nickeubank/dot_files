...
cdef class SIModel(object):
    """SI epidemic model for networks."""
    
    cdef __init__(self, object graph, set nodes_to_watch, float p=0.1, bool tests=False, 
                 int starting_infections=1, int seed=None, bool debug=False, 
                 object initial_infection=None):
    ...
    def step(self, iteration_counter=None):
        ...
        for vertex in self.infected:
            ...
            choices = sample_from_neighbors(neighbors, self.p)
